...
function UploadModeModal({visible, onClose, onLaunchImageLibrary, newItem, saveItem, handleUpdate, handleCancle, saveSymbols}) {
      ...
      onRequestClose={onClose} >
        ...
        <View style={styles.whiteBox}>
          <Pressable
            ...
            onPress={() => {
             navigation.navigate('CameraViewNonavigation',{newItem, saveItem, handleUpdate, handleCancle, saveSymbols,})
              onClose();
            }} >
