...
import { ClothWriteNavigation, LoadingScreen } from ".";
...
export default function CameraViewNonavigation({route, navigation}) {
    const {newItem, saveItem, handleUpdate, handleCancle, saveSymbols} = route.params;
              ...
              {photos && photos.length > 0 && (
                  <SafeAreaView>
                      ...
                      <View style={styles.showPhotoView}>
                          <TouchableOpacity style={styles.showPhotoButton} >
                              <Text style={styles.showPhototext}>다시 찍기</Text>
                          </TouchableOpacity>
                          <TouchableOpacity style={styles.showPhotoButton} onPress={() => navigation.navigate("ClothWriteNavigation", {key, newItem, saveItem, handleUpdate, handleCancle, saveSymbols})}>
                              <Text style={styles.showPhototext}>완료</Text>
                          </TouchableOpacity>
                      </View>
                  </SafeAreaView>
              )}
